...
try:
    from onshape_client.oas.models import btm_mate_connector66_all_of
except ImportError:
    btm_mate_connector66_all_of = sys.modules[
        "onshape_client.oas.models.btm_mate_connector66_all_of"
    ]
try:
...
class BTMMateConnector66(ModelComposed):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """btm_mate_connector66.BTMMateConnector66 - a model defined in OpenAPI
